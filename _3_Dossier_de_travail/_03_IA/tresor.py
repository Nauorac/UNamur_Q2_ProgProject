...
def Ai(teams,equipe):
    ...
    if ((position_alpha[0],position_alpha[1]) in  teams[(position_alpha[0],position_alpha[1])][2]<100):
        #verifier si mon loup alpha est sur une ressource et il a un manque d'energie
...
path = "_3_Dossier_de_travail\example.ano"
size = []
entities={}
